...
**[Metric WebApp]** is a responsive web application that allows users to view a list of African countries. The wepapp has two pages: the home page and the details page.
