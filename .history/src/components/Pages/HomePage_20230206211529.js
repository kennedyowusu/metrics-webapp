...
const HomePage = () => {
  ...
  return (
    <div className=''>
     ...
     <div className='flex items-center justify-center w-28 h-10 mr-12 rounded-md text-2xl text-white border border-white border-rounded hover:bg-white hover:text-teal-800
        '>
