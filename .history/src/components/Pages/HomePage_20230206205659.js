...
const HomePage = () => {
  ...
  return (
    <div className=''>
     ...
     <div
          className='flex items-center justify-center w-full h-16 bg-white rounded-lg shadow-md'
     >
          <input
            type='text'
            placeholder='Search for a country'
            className='w-36 h-10 px-4 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500'
