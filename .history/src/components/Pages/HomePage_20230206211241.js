  ...
  return (
    <div className=''>
      <div className='flex bg-teal-800 p-2'>
        <div className='flex items-center justify-center w-28 h-10 mr-2 rounded-md text-2xl text-white'>
        ...
        <div className='flex items-center justify-center ml-24 rounded-md'>
          ...
          />
          <button className='w-10 h-10 ml-2 text-2xl bg-blue-500 rounded-lg flex justify-center items-center'>
