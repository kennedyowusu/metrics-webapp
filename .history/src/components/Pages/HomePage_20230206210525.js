  ...
  return (
    <div className=''>
      <div className='flex bg-teal-800 p-2'>
        ...
        <div className='flex items-center justify-center ml-36 rounded-md'>
          <input
            type='text'
            placeholder='Search for a country'
            className='w-44 h-10 px-4 rounded-md focus:outline-none focus:border-blue-500 p-4'
            onChange={handleDataSearch}
          />
          <button className='w-10 h-10 ml-2 bg-blue-500 rounded-lg flex justify-center items-center'>
