...
const HomePage = () => {
  ...
  return (
    <div className=''>
      ...
      sm:w-32 sm:h-12 sm:mr-44 sm:text-[2.5rem] md:w-36 md:h-14 md:mr-64 md:text-[3rem] lg:w-40 lg:h-16 lg:mr-64 lg:text-[3.5rem] xl:w-44 xl:h-18 xl:mr-28 xl:text-[4rem] 2xl:w-48 2xl:h-20 2xl:mr-32 2xl:text-[4.5rem]
          '>
