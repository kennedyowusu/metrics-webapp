  ...
  return (
    <div className=''>
      ...
      className='flex items-center justify-center w-28 h-10 mr-12 rounded-md text-[2rem] text-white 
           sm:w-32 sm:h-12 sm:mr-24 sm:text-[2.5rem] md:w-36 md:h-14 md:mr-20 md:text-[3rem] lg:w-40 lg:h-16 lg:mr-24 lg:text-[3.5rem] xl:w-44 xl:h-18 xl:mr-28 xl:text-[4rem]
          '>
