...
const DetailsPage = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-start bg-teal-900'>
      ...
      '
        >
          <button
            className='text-xl p-4 hover:text-gray-500 text-start text-teal-500
          rounded-lg
        '
            onClick={() => navigate(-1)}
          >
        ...
        <div className='flex items-center justify-center mt-4 mb-5 text-center bg-teal-500 text-white'>
          <p className='text-md font-medium p-1'>
