...
const HomePage = () => {
  ...
  return (
    ...
    <div className='flex flex-col items-center'>
      <div className='flex items-center justify-center mb-6 bg-teal-500'>
        <img
          src='https://via.placeholder.com/100x100'
          alt='Logo'
        ...
        <input
          ...
          value={searchTerm}
          onChange={handleSearch}
          className='w-full md:w-64 p-2 rounded-lg border-2 border-gray-200 focus:outline-none focus:border-gray-500'
        />
      </div>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
        {filteredCountries.map((country) => (
