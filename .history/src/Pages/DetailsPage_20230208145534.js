    ...
    <div className='flex flex-col items-center justify-start '>
      ...
      <div className='mx-auto max-w-sm p-6 rounded-lg bg-teal-400'>
        ...
        <div className='flex items-center justify-center mt-4 mb-2 text-center bg-teal-700 text-white'>
          <h2 className='text-md font-medium p-2'>{country.name}</h2>
        </div>
        <div className='flex items-center justify-center mt-4 mb-2 text-center bg-teal-700 text-white'>
          <p className='text-md font-medium'>Capital: {country.capital}</p>
        </div>
        <div className='flex items-center justify-center mt-4 mb-2 text-center bg-teal-700 text-white'>
        ...
        <div
          className='flex items-center justify-center mt-4 mb-2 text-center bg-teal-700 text-white'
        >
          <p className='text-md font-medium'>Area: {country.area} km²</p>
        </div>
      </div>
    </div>
  )
